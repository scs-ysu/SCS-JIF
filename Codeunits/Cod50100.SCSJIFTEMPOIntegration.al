codeunit 50100 "SCSJIF TEMPO Integration"
{
    ...
    var
        ...
        TxtAccountMissing: Label 'Tempo Account key is empty.';
        TxtTempoCustMissing: Label 'Jira Customer is missing.';
        TxtTempoRespPersonMissing: Label 'Jira Responsible Person is missing.';
        TxtNAVJobTskMissing: Label  'Job Task is missing.';
        TxtNAVJobNotExist: Label 'Job "%1" does not exist.';
        TxtNAVJobTskNotExist: Label 'Job Task "%2" does not exist for Job "%1".';
        ...
        TxtParseError: Label  'Illegal XML response received from TEMPO-Servlet. Try URL in browser: %1';
        TxtSendRequestError: Label 'Send request ended with error code %1, description %2.';
        TxtAccountSynched: Label  'Tempo account %2 for customer %1 passed the filter, adding to accounts workfile. ';
        gLog: Record "SCSJIFJIRA/Tempo-Sync Log file";
        TxtGETtingURL: Label  'Getting URL: %1';
        TxtLoadingTempoAccounts: Label 'Loading Tempo accounts to workfile...';
        TxtLoadingTempoWorklogs: Label  'Loading Tempo worklogs to workfile...';
        ...
        TxtNodesReceived: Label '%1 detail nodes received.';
        TxtUpdatingJobs: Label  'Updating Accounts -> Jobs...';
        TxtUpdatingJobTaskLine: Label 'Updating Worklog -> Job Task Line...';
        TxtUpdatingJobPlanningLines: Label 'Updating Worklogs -> Job Planning Lines (contract)...';
        TxtWorkLogAlreadyAssigned: Label 'Worklog %1 for %2 already assigned to planning line %3/%4/%5. Updating.';
        TxtWorkLogNotYetAssigned: Label 'Worklog %1 for %2 not yet assigned to any line.';
        TxtWorkLogAssignedMultiple: Label 'Worklog %1 for %2 assigned to multiple planning lines.';
        TxtJobTaskAdded: Label 'Task %2 (%3) has been added to job %1.';
        TxtJobTaskFoundByIssue: Label  'Task %1/%2 (%3) found for issue %4. Adopting.';
        TxtNAVJobTskIDNotFound: Label 'No Job Task ID could be found. Check Setup.';
        TxtWorkLogAssigned: Label 'Worklog %1 for %2 assigned to planning line %3/%4/%5.';
        TxtPlanningLinesResetFilter: Label  'Resetting Planning Lines. Filtered to: %1';
        TxtPlanningLinesDeleteFilter: Label 'Deleting orphaned Planning Lines (deleted or reassigned in Tempo). Filtered to: %1';
        TxtJobPlanningLineAlreadyInvoiced: Label  'Worklog %1 for %2 already assigned to planning line %3/%4/%5. Values were changed in Tempo but  line is already invoiced. Update NOT possible.';
        TxtWorkLogNotChanged: Label 'Worklog %1 for %2 already assigned to planning line %3/%4/%5. Values were not changed in Tempo, update skipped.';
